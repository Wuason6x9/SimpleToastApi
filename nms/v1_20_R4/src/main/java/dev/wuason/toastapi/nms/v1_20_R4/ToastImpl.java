package dev.wuason.toastapi.nms.v1_20_R4;
...
public class ToastImpl implements IToastWrapper {
    ...
    public void sendToast(ItemStack icon, Player player, String title, EToastType toastType, String namespace, String path) {
        ...
        Optional<DisplayInfo> displayInfo = Optional.of(new DisplayInfo(iconNMS, Component.Serializer.fromJson(title, craftServer.getServer().registryAccess()), Component.literal("."), Optional.empty(), AdvancementType.valueOf(toastType.toString()), true, false, true));
