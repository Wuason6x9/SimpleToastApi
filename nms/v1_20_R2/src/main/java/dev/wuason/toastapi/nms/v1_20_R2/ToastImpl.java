...
public class ToastImpl implements IToastWrapper {
    ...
    public void sendToast(ItemStack icon, Player player, String title, EToastType toastType, String namespace, String path) {
        ...
        Optional<DisplayInfo> displayInfo = Optional.of(new DisplayInfo(iconNMS, Component.literal(title), Component.literal("."), null, FrameType.valueOf(toastType.toString()), true, false, true));
