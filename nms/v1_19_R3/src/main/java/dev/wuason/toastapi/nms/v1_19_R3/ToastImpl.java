package dev.wuason.toastapi.nms.v1_19_R3;
...
public class ToastImpl implements IToastWrapper {
    ...
    public void sendToast(ItemStack icon, Player player, String title, EToastType toastType, String namespace, String path) {
        ...
        DisplayInfo displayInfo = new DisplayInfo(iconNMS, Objects.requireNonNull(Component.Serializer.fromJson(title)), Component.literal("."), null, FrameType.valueOf(toastType.toString()), true, false, true);
